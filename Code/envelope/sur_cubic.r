...
# Uses Seemingly Unrelated Regression with cubic covariates 
...
sur_cubic = function(data) {
	...
	# SUR formulae
	form1 = logit(parity_proportion1) ~ year*age + mf_ratio + births*age + tfr + year2*age2 + year3 + age3
	form2 = logit(parity_proportion2) ~ year*age + mf_ratio + births*age + tfr + year2*age2 + year3 + age3
	form3 = logit(parity_proportion3) ~ year*age + mf_ratio + births*age + tfr + year2*age2 + year3 + age3
	form4 = logit(parity_proportion4) ~ year*age + mf_ratio + births*age + tfr + year2*age2 + year3 + age3
