...
# Uses Seemingly Unrelated Regression with quadratic covariates and "full" interactions
...
# start function
sur_quadratic_full = function(data) {
	...
	# SUR formulae
	form1 = logit(parity_proportion1) ~ year*age*mf_ratio*births*tfr+year2*age2
	form2 = logit(parity_proportion2) ~ year*age*mf_ratio*births*tfr+year2*age2
	form3 = logit(parity_proportion3) ~ year*age*mf_ratio*births*tfr+year2*age2
	form4 = logit(parity_proportion4) ~ year*age*mf_ratio*births*tfr+year2*age2
